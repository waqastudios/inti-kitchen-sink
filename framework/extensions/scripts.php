...
function inti_register_scripts() {
	...
	// wp_register_script('js-cookie', get_stylesheet_directory_uri() . '/library/dist/js/jquery.cookie.js', array(), filemtime(get_stylesheet_directory() . '/library/dist/js/jquery.cookie.js'), true);
